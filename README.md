...
region, and network attributes recovered from the existing DB Terraform state;
destroy does not consume deploy-time GitHub variables or K8s remote state. Normal
apply continues to discover production private subnets and the VPC from K8s
