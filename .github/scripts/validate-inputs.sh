...
jq -n \
  ...
  '{environment:$environment,aws_region:$aws_region,hml_public_subnet_ids:$hml_public_subnet_ids,hml_allowed_cidr_blocks:$hml_allowed_cidr_blocks,prod_allowed_security_group_ids:$prod_allowed_security_group_ids,prod_lambda_security_group_ids:$prod_lambda_security_group_ids}' \
  > "$output"
